...
<div class="container">
	...
	<!-- container -->
		...
		echo "<h2></h2>
		Welcome 
		The main objective is to reduce the paper wastage";
		}
		?>
...
<!-- footer-->
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="admin/login.php"> Developed by VENKATA_SREERAM_MALLULA</a></li>
	<div class="col-12 navbar-right">
	<img src="images/262.jpg" width="100px" alt="...">
     </div> 
	</ul>
